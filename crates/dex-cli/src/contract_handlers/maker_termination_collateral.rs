...
use simplicity_contracts_adapter::dcd::{
    BaseContractContext, CommonContext, DcdContractContext, DcdManager, MakerTerminationCollateralContext,
};
...
pub fn handle(
    ...
    let transaction = DcdManager::maker_collateral_termination(
